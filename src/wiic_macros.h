...
#define WIIMOTE_TOGGLE_STATE(state, s)		((state & (s)) ? WIIMOTE_DISABLE_STATE(state, s) : WIIMOTE_ENABLE_STATE(state, s))
...
#define WIIMOTE_TOGGLE_FLAG(flags, s)		((flags & (s)) ? WIIMOTE_DISABLE_FLAG(flags, s) : WIIMOTE_ENABLE_FLAG(flags, s))

#define NUNCHUK_IS_FLAG_SET(flags, s)		((*(flags) & (s)) == (s))

/* misc macros */
#define WIIMOTE_IS_CONNECTED(state)		(WIIMOTE_IS_STATE_SET(state, WIIMOTE_STATE_CONNECTED))
...
#define WIIC_INIT_FLAGS				(WIIC_CONTINUOUS | WIIC_ORIENT_THRESH)
